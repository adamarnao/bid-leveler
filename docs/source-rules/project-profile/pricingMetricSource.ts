...
export const sectorPricingMetricGroups: SectorPricingMetricGroup[] = [
  {
    ...
    metrics: [
      {
        id: "rentable_square_footage",
        label: "Rentable SF",
        valueType: "area",
        unit: "sf",
      },
      {
        id: "sales_floor_square_footage",
        label: "Sales Floor SF",
        valueType: "area",
        unit: "sf",
      },
      {
        id: "kitchen_square_footage",
        label: "Kitchen SF",
        valueType: "area",
        unit: "sf",
      },
  ...
  },
  {
    ...
    metrics: [
      ...
      {
        id: "treatment_room_count",
        label: "Treatment Rooms",
        valueType: "number",
        unit: "count",
      },
      {
        id: "imaging_room_count",
        label: "Imaging Rooms",
        valueType: "number",
        unit: "count",
      },
      {
        id: "procedure_room_count",
        label: "Procedure Rooms",
        valueType: "number",
        unit: "count",
      },
      {
        id: "med_gas_outlet_count",
        label: "Med Gas Outlet Count",
        valueType: "number",
        unit: "count",
      },
    ],
  },
  {
    ...
    metrics: [
      ...
      {
        id: "public_area_square_footage",
        label: "Public Area SF",
        valueType: "area",
        unit: "sf",
      },
      {
        id: "restaurant_bar_square_footage",
        label: "Restaurant / Bar SF",
        valueType: "area",
        unit: "sf",
      },
    ],
  },
  {
    ...
    metrics: [
      ...
      {
        id: "common_area_square_footage",
        label: "Common Area SF",
        valueType: "area",
        unit: "sf",
      },
      {
        id: "multifamily_floor_count",
        label: "Floors",
        valueType: "number",
        unit: "count",
      },
  ...
  },
  {
    ...
    metrics: [
      {
        id: "warehouse_square_footage",
        label: "Warehouse SF",
        valueType: "area",
        unit: "sf",
      },
      {
        id: "office_square_footage",
        label: "Office SF",
        valueType: "area",
        unit: "sf",
      },
      ...
      {
        id: "cold_storage_square_footage",
